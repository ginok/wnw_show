...
jCarousel.set=function(arg){
    ...
    $(".jCarousel").each(function(){
        if(!$(this).attr("name")){
            ...
            $(".jCarouselWrapper"+tNum).append($("<div>").attr("id","jCarousel-counter").css({"position":"fixed","left":"90%","top":"0%"}));
            ...
            $(".jCarouselWrapper"+tNum+" .jCarouselNavi a.selected").css({backgroundColor:jCarousel.color.active});
...
jCarousel.slide=function(activeNum,carouselNum,speed){
    ...
    $(".jCarouselWrapper"+tNum+" .jCarouselNavi a[rel='"+carouselNum+"']").css({backgroundColor:jCarousel.color.active});
    $("#jCarousel-counter").html(carouselNum + "/" + jCarousel.maxNum(tNum));
};

jCarousel.currentNum=function(activeNum){
    return jCarousel.sel[activeNum].current;
};
jCarousel.maxNum=function(activeNum){
    return jCarousel.target[activeNum].childElementCount;
};
