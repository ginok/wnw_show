...
(function(){
    ...
    function start(msg,callback,topImageUrl,logoUrl){
        ...
        gBacks[0]=new Back(new Position(10,10,1200,750) , wnw.show.libPath() + "/images/background.png",0,1);//背景のピンクの四角
        gBacks[1]=new Back(new Position(61,385,178,495) , wnw.show.libPath() + "/images/env0.gif",0,1);
        gBacks[2]=new Back(new Position(277,349,392,435) , wnw.show.libPath() + "/images/env1.gif",0,1);
        gBacks[3]=new Back(new Position(430,138,995,563) , wnw.show.libPath() + "/images/env2.gif",0,1);
        gBacks[4]=new Back(new Position(1024,337,1135,433) , wnw.show.libPath() + "/images/env3.gif",0,1);
        gBacks[5]=new Back(new Position(234,203,356,302) , wnw.show.libPath() + "/images/env4.gif",0,1);
        gBacks[6]=new Back(new Position(679,83,760,136) , wnw.show.libPath() + "/images/env5.gif",0,1);
        gBacks[7]=new Back(new Position(885,40,992,117) , wnw.show.libPath() + "/images/env6.gif",0,1);
        gBacks[8]=new Back(new Position(125,615,259,680) , wnw.show.libPath() + "/images/env7.gif",0,1);
        gBacks[9]=new Back(new Position(279,521,374,597) , wnw.show.libPath() + "/images/env8.gif",0,1);
        gBacks[10]=new Back(new Position(458,602,546,651) , wnw.show.libPath() + "/images/env9.gif",0,1);
        gBacks[11]=new Back(new Position(602,569,688,641) , wnw.show.libPath() + "/images/env10.gif",0,1);
        gBacks[12]=new Back(new Position(801,576,917,672) , wnw.show.libPath() + "/images/env11.gif",0,1);
        gBacks[13]=new Back(new Position(968,641,1070,740) , wnw.show.libPath() + "/images/env12.gif",0,1);
        gBacks[14]=new Back(new Position(10,10,800,210) , wnw.show.libPath() + "/images/kirakira2.gif",255,1);
